...
public class ApplicantService {
    ...
    public Long upsert(String name, int age, String phoneNumber) {
        validateApplicant(name, age, phoneNumber);
    ...
    public ApplicantResponse getByIdDto(Long id) {
    ...
    private void validateApplicant(String name, int age, String phoneNumber) {
...
//    }
//
//    public void validateApplicant(String name, int age, String phoneNumber) {
//        if (name == null || name.length() < 2 || name.length() > 10) {
//            throw new IllegalArgumentException("이름은 2~10자여야 합니다.");
//        }
//        if (age < 22 || age > 30) {
